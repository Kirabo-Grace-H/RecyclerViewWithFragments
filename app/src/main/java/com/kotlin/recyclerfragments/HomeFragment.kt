...
class HomeFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
       ...
       // val employeeList=Constants.getEmployeeData()
        ...
        val itemAdapter = MyAdapter(employeeList)
        //set the layout manager that this recycler view will use
        val recycleView = view.findViewById<RecyclerView>(R.id.recyclerV)
        recycleView.layoutManager=LinearLayoutManager(context)
        //adapter instance is set to the recycler to inflate the items
